...
Welcome to the documentation hub for multiple projects by Khang Duy Tran.

This site hosts technical documentation for several projects, each organized under the **Projects** section.

---

## Projects

- **[Sensor Hub - Wireless Sensor Network](projects/sensor-hub/index.md)** - A distributed sensor system collecting, processing, and visualizing environmental data using wireless sensor nodes and an edge computing gateway.
